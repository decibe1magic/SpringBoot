package com.blackcode.www.theme.thymeleaf.caminar;
...
public class CaminarController {
	private String path = "thymeleaf/theme/caminar";
	
	@GetMapping("/theme/thymeleaf/caminar")
	...
	@GetMapping("/theme/thymeleaf/caminar/elements")
